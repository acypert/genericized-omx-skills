---
name: wiki
description: Persistent markdown project wiki stored under docs/wiki with keyword search and lifecycle capture
...
## Auto-Capture
At session end, discoveries can be captured as `session-log-*` pages. Configure via `docs/wiki/config.json`.

## Hard Constraints
- No vector embeddings — query uses keyword + tag matching only
- Wiki files remain local project state under `docs/wiki/`
